...
const port = process.env.SERVER_PORT || process.env.PORT || 8400;        
const UUID = process.env.UUID || 'c4760d31-4063-44a4-8c30-d235e13940d0'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'chejswy.jswymydns.us.kg';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiMDFlMDJhM2MxODM5YzJlOWE4MGRmZWFkMzcyYjdiYTciLCJ0IjoiM2ViMmRjNzAtMWY4MS00YzUxLWFkNmYtNGIxODY0ZDBlZGI5IiwicyI6Ik1XWmtNVE5qWW1ZdFlXVm1ZaTAwWlRreUxUbGtPV0V0TURRM1pHTmhPRFZoTXpVMiJ9';
